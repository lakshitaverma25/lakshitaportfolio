        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-80 h-80 mx-auto relative group hover:scale-105 transition-all duration-500">
                <div className="absolute -inset-20 bg-gradient-radial from-cyan-400/20 via-cyan-400/10 via-blue-400/5 to-transparent blur-3xl opacity-60 animate-pulse-slow"></div>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-black/40 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:scale-105 transition-all duration-300 shadow-2xl"
                 style={{ 
                   boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3), 0 10px 20px rgba(6, 182, 212, 0.1)'
                 }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full hover:rotate-12 transition-transform duration-300 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center shadow-xl"
                style={{ 
              ...
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg-gradient-to-br from-purple-500/20 to-red-500/20 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center shadow-xl"
                style={{ 
